...
export const ProjectsData = [
    {
        ...
        detail: "ppob-dypedia",
        tasks: [
            "Designed UI for landing page, admin, and super admin using Figma",
            "Developed responsive landing and admin pages using React.js and Tailwind CSS.",
            "Integrated backend APIs using Axios for real-time data handling.",
        ],
        techs: ["React JS", "Express JS", "Tailwind", "MySQL", "Postman", "Figma", "Axios", "Midtrans"]
    },

    {
        ...
        detail: "marketplace-website",
        tasks: [
            "Designed UI for landing page, admin, and super admindashboards using Figma.",
            "Created, designed, and normalized relational databases using MySQL.",
...

    {
        ...
        demo: "https://langit-saji.vercel.app/",
        detail: "restaurant-website",
        tasks: [
            "Developed the entire frontend using Next.js and Tailwind CSS.",
            "Designed a responsive user interface tailored for small businesses(UMKM).",
            "Focused on fast performance, clean layout, and mobilefriendly experience.",
        ],
...

    {
        ...
        demo: "https://ruang-raya.vercel.app/",
        detail: "furniture-website",
        tasks: [
            "Built a fully responsive e-commerce frontend using Next.js and Tailwind CSS.",
            "Designed a clean and modern user interface optimized for product showcasing.",
            "Implemented dynamic product listings and intuitive navigation for better user experience.",
        ],
        techs: ["Next JS", "Tailwind"]
    },

    {
        ...
        detail: "gc-tools",
        tasks: [
            "Developed a frontend tool platform using React.js and Tailwind CSS.",
            "Provided ready-to-copy UI components like forms, buttons, and cards to speed up development.",
            "Designed a clean and responsive interface to enhance usability and developer productivity.",
        ],
...

    {
        ...
        tasks: [
            "Served as Project Manager and Team Leader.",
            "Acted as Fullstack Developer: developed frontend with React.js and Tailwind CSS, and backend using Express.js and MySQL.",
            "Designed user interface (UI) using Figma.",
    ...
    
    {
        ...
        detail: "daily-agenda",
        tasks: [
            "Developed the frontend using Laravel Blade templates and CSS.",
            "Focused on clean UI and user-friendly layout for task management features.",
        ],
        techs: ["PHP", "CSS", "MySQL"]
    },

    {
        ...
        tasks: [
            "Designed the UI in Figma, focusing on usability and layout for students and administrators.",
            "Created and structured the database using MySQL.",
            "Developed the website using native PHP with a focus on core functionality and clean structure."
        ],
        techs: ["PHP", "CSS", "MySQL"]
    },

    {
        ...
        tasks: [
            "Developed the entire frontend using Next.js and Tailwind CSS.",
            "Focused on clean design, responsive layout, and efficient component structure for a smooth user experience.",
        ],
        techs: ["Next JS", "Tailwind"]
    },

    {
        ...
        detail: "dynamic-box-styler",
        tasks: [
            "Built a web-based styling tool using pure HTML, CSS, and JavaScript.",
            "Created interactive controls to adjust box styles such as width, height, border, and colors.",
            "Implemented real-time preview and code generation for easy copying and use.",
        ],
...

    {
        ...
        demo: "",
        detail: "pharmacy-website",
        tasks: [
            "Developed the frontend and backend using Laravel and Bootstrap for a responsive user experience.",
            "Designed and implemented a MySQL database to manage users, medicines, and transactions.",
            "Created functionality for users to browse and request medicines, and for pharmacists to manage orders.",
        ],
